...
default['orchestrator']['config']['HostnameResolveMethod'] = 'default'
default['orchestrator']['config']['MySQLHostnameResolveMethod'] = '@@hostname'
...
default['orchestrator']['config']['FailMasterPromotionOnLagMinutes'] = 0
